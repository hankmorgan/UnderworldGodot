...
namespace Underworld
{
    public class pillar : model3D
    {
        ...
        public static pillar CreateInstance(Node3D parent, uwObject obj, string name)
        {
            var n = new pillar(obj, parent.Position);
        ...
        {//Get the material texture from tmobj            
            return GetTmObj.GetMaterialForObject((byte)textureno,uwobject);
        }
