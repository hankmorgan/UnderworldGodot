        ...
        public override int[] ModelTriangles(int meshNo)
        {
            switch (meshNo)
            {
                case 0: //Prison tower face
                    return new int[] { 17, 27, 32, 17, 30, 27, 17, 16, 30 };
                case 1: //Kilhorn face
                    return new int[] { 18, 16, 17, 18, 15, 16, 18, 12, 15 };
                case 2:
                    return new int[] { 8, 12, 18, 8, 13, 12, 8, 7, 13 };
                case 3: //Talorus face					
                    return new int[] { 1, 7, 8, 1, 2, 7, 1, 9, 2 };
                case 4: //academy
                    return new int[] { 1, 10, 9, 1, 5, 10, 5, 4, 10 };
                case 5: //Pits
                    return new int[] { 33, 4, 5, 33, 31, 4, 33, 28, 31 };
                case 6: //Tomb
                    return new int[] { 34, 28, 33, 34, 25, 28, 34, 22, 25 };
                case 7: //Void
                    return new int[] { 32, 22, 34, 32, 23, 22, 32, 27, 23 };
                case 8: // base + cap
                    return new int[] { 24, 25, 22, 24, 22, 23, 26, 23, 27, 26, 27, 30, 39, 30, 16, 39, 16, 15, 14, 15, 12, 14, 12, 13, 13, 7, 21, 7, 2, 21, 2, 9, 11, 9, 10, 11, 10, 4, 38, 4, 31, 38, 31, 28, 29, 29, 28, 25, 0, 1, 3, 0, 5, 1, 0, 33, 5, 0, 36, 33, 33, 36, 37, 37, 34, 33, 37, 32, 34, 37, 35, 32, 32, 35, 20, 32, 20, 17, 17, 20, 18, 18, 19, 8, 8, 19, 6, 8, 6, 3, 8, 3, 1, 18, 20, 19, 0, 3, 6, 0, 6, 19, 0, 19, 20, 0, 20, 35, 0, 35, 37, 0, 37, 36 };
            }
