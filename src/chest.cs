...
namespace Underworld
{
    public class chest : model3D
    {
        ...
        public static chest CreateInstance(Node3D parent, uwObject obj, string name)
        {
            var s = new chest(obj);
        ...
        public chest(uwObject _uwobject)
        {
            uwobject = _uwobject;
        }
        ...
        public override int[] ModelTriangles(int meshNo)
        {
            ...
            {
                case 0://detail trim
                    return new int[] { 18, 56, 21, 18, 13, 56, 13, 54, 56, 13, 53, 54, 53, 50, 54, 53, 49, 50, 49, 46, 50, 49, 47, 46, 47, 48, 45, 47, 45, 46, 48, 52, 51, 48, 51, 45, 51, 12, 55, 51, 52, 12, 55, 15, 26, 55, 12, 15, 20, 5, 6, 5, 20, 38, 5, 37, 30, 5, 38, 37, 30, 37, 39, 30, 39, 29, 29, 39, 40, 29, 40, 28, 28, 40, 41, 28, 41, 2, 2, 41, 43, 2, 43, 42, 42, 43, 44, 42, 44, 1, 1, 44, 25, 1, 25, 0, 0, 25, 15, 25, 26, 15, 21, 6, 18, 21, 20, 6, 19, 56, 38, 22, 56, 19, 65, 67, 66, 65, 64, 67, 44, 55, 24, 55, 23, 24};
                case 1://main body
