...
namespace Underworld
{
    ...
    {
        /// <summary>
        /// Triggers a trigger that runs when the player enters any part of a tile
        /// </summary>
        /// <param name="triggerIndex"></param>
        /// <param name="objList"></param>
        public static bool EnterTrigger(uwObject srcObject, int triggerIndex, uwObject[] objList)
        {
