...
namespace Underworld
{
    ...
    public class ObjectCreator : UWClass
    {
        ...
        {
            Debug.Print ($"Trap {obj.a_name} {obj.index} {obj.tileX},{obj.tileY} Class {obj.majorclass}-{obj.minorclass}-{obj.classindex} Params[{obj.flags} {obj.quality},{obj.owner}] Link {obj.link}");
            switch (obj.minorclass)
            {
                case 0: //traps
                    {
